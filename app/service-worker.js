const CACHE='vipoap-app-v12';
const ASSETS=['/app/','/app/index.html','/app/account','/app/booking-payment.js','/app/booking-help.js','/app/payment-checkout.js','/app/account-link.js','/app/account-help.js','/app/manifest.webmanifest','/assets/connectivity.js','/assets/fonts.css','/assets/fonts/quicksand-latin.woff2','/assets/vipoap-heart-transparent.png','/assets/icon-192.png?v=3','/assets/icon-512.png?v=3'];
