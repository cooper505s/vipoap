const CACHE='vipoap-app-v23';
const ASSETS=['/app/','/app/index.html','/app/account','/app/account.css?v=1','/app/account-family.css?v=1','/app/account.js?v=3','/app/guided-help.js','/app/booking-payment.js?v=2','/app/booking-help.js','/app/payment-checkout.js?v=2','/app/stripe-embedded.js?v=1','/app/account-link.js','/app/account-help.js','/app/account-home.js','/app/account-profile.js','/app/account-health.js','/app/preferred-engineer.js','/app/account-ask.js','/app/manifest.webmanifest','/assets/connectivity.js','/assets/fonts.css','/assets/fonts/quicksand-latin.woff2','/assets/vipoap-heart-transparent.png','/assets/favicon-32.png','/assets/icon-192.png?v=3','/assets/icon-512.png?v=3'];
