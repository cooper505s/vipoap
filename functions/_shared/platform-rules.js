export const DEFAULT_RULES=Object.freeze({
  version:'v4-remote-engineer-70-percent',
...
export async function platformRules(env){const saved=env.VIPOAP_DATA?await env.VIPOAP_DATA.get('config:platform-rules','json'):null,result=merge(DEFAULT_RULES,saved||{});if(saved?.version!==DEFAULT_RULES.version){result.version=DEFAULT_RULES.version;result.prices={...DEFAULT_RULES.prices};result.engineerEntitlements={...DEFAULT_RULES.engineerEntitlements}}return result}
