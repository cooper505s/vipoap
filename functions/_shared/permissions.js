...
export const BUILT_IN_ROLES={
  ...
  operator:{id:'operator',name:'Engineer Partner',description:'Engineer workspace for assigned bookings, completed visits, training, safety and local marketing.',permissions:['manage_calls','view_training','manage_marketing','report_incidents'],system:true},
