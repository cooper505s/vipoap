...
test('guided help is available offline in the customer app',()=>{const worker=read('app/service-worker.js');assert.match(worker,/vipoap-app-v19/);assert.match(worker,/\/app\/guided-help\.js/)})
