...
test('OS service worker never intercepts APIs and versions the shared shell',()=>{
  ...
  for(const asset of ['vipoap-os-v38','email-login.js?v=6','mobile-nav.js?v=3','knowledge.js?v=2','/admin/hq','header.css','callout-camera.js','billing-settlements.js','availability-calendar.js','operational-health.js?v=2','launch-readiness.js','backup-controls.js','restore-controls.js','maintenance-controls.js','distribution-alerts.js','manual-assignment.js','training-learning.js?v=2','ticket-workspace.js?v=1','control-overview.js?v=1','zoho-sync.js','reviews.js','connectivity.js','vipoap-os-icon-192','/admin/training','/admin/knowledge','/admin/franchise','/admin/safety','/admin/my-payments','my-payments.js'])assert.ok(worker.includes(asset),asset);
